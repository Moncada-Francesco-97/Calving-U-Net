...
def rf_train_and_fit(X, y, cv_split, param_grid):
    ...
    grid_search = GridSearchCV(estimator=rf, param_grid= param_grid, cv=cv_split, verbose=2, n_jobs=-1, scoring='neg_mean_squared_error') #lower values are better
